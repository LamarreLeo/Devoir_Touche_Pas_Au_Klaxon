<div class="bg-[#f1f8fc]">
    <div class="flex flex-col items-center justify-center h-[calc(100vh-128px)]">
        <div class="bg-[#384050] text-white max-w-[600px] mx-auto w-full p-12 rounded-lg">
            ...
            <form method="POST" action="/Devoir_Touche_Pas_Au_Klaxon/PHP/public/agences/edit?id=<?= $agence['id'] ?>" class="flex flex-col gap-6">
                <div class="flex flex-col gap-6">
                    <h3 class="text-2xl font-bold text-center mb-4">Modifier une agence</h3>
                ...
                <div class="flex gap-4 justify-center mt-8">
                    <button type="submit" class="bg-[#82b864] text-white px-8 py-3 rounded-lg font-bold cursor-pointer hover:opacity-90 transition-opacity">Modifier l'agence</button>
