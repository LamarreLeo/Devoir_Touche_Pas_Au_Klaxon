<div class="bg-[#f1f8fc]">
    <div class="flex flex-col items-center justify-center h-[calc(100vh-128px)]">
        <div class="bg-[#384050] text-white max-w-[1200px] mx-auto w-full p-12 rounded-lg">
            ...
            <form action="/Devoir_Touche_Pas_Au_Klaxon/PHP/public/trajets/edit?id=<?= $trajet['id'] ?>" method="post" class="flex flex-col gap-6">
                <div class="flex flex-col gap-6">
                    <h3 class="text-2xl font-bold text-center mb-4">Modifier un trajet</h3>
                    ...
                    <div class="p-4 rounded-lg border border-[#0074c7]">
                        ...
                        <p class="text-lg">
                            ...
                            <span class="text-sm opacity-75 block mt-1"><?= htmlspecialchars($trajet['user_email']) ?></span>
                        </p>
                    </div>
                    ...
                    <div class="flex justify-center gap-12">
                        ...
                        <div class="flex-1">
                            ...
                            >
                                ...
                                <?php foreach ($agences as $agence) : ?>
                                    <option 
                                        value="<?= $agence['id'] ?>"
                                        <?= (isset($data['agence_depart_id']) && $data['agence_depart_id'] == $agence['id']) || $trajet['agence_depart_id'] == $agence['id'] ? 'selected' : '' ?>
                                    >
                        ...
                        <div class="flex-1">
                            ...
                            <input 
                                ...
                                value="<?= $data['date_heure_depart'] ?? $trajet['date_heure_depart'] ?>"
                                required
                                class="w-full p-3 rounded-lg border-2 border-[#0074c7] bg-white text-[#384050] focus:outline-none focus:border-[#00497c] transition-colors"
                            >
                        </div>
                    ...
                    <div class="flex justify-center gap-12">
                        ...
                        <div class="flex-1">
                            ...
                            >
                                ...
                                <?php foreach ($agences as $agence) : ?>
                                    <option 
                                        value="<?= $agence['id'] ?>"
                                        <?= (isset($data['agence_arrivee_id']) && $data['agence_arrivee_id'] == $agence['id']) || $trajet['agence_arrivee_id'] == $agence['id'] ? 'selected' : '' ?>
                                    >
                                        <?= htmlspecialchars($agence['ville']) ?>
                                    </option>
                                <?php endforeach; ?>
                        ...
                        <div class="flex-1">
                            ...
                            <input 
                                ...
                                value="<?= $data['date_heure_arrivee'] ?? $trajet['date_heure_arrivee'] ?>"
                                required
                                class="w-full p-3 rounded-lg border-2 border-[#0074c7] bg-white text-[#384050] focus:outline-none focus:border-[#00497c] transition-colors"
                            >
                        </div>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            min="1"
                            max="10"
                            value="<?= $data['places'] ?? $trajet['places'] ?>"
                            required
                            class="w-full p-3 rounded-lg border-2 border-[#0074c7] bg-white text-[#384050] focus:outline-none focus:border-[#00497c] transition-colors"
                        >
                ...
                <div class="flex gap-4 justify-center mt-8">
                    <button type="submit" class="bg-[#82b864] text-white px-8 py-3 rounded-lg font-bold cursor-pointer hover:opacity-90 transition-opacity">Modifier le trajet</button>
